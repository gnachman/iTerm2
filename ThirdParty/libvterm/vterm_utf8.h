// This is based on utf.h from libvterm but was hacked up to work in iTerm2.

/* The following functions copied and adapted from libtermkey
 *
 * http://www.leonerd.org.uk/code/libtermkey/
 */
static inline unsigned int vterm_utf8_seqlen(long codepoint)
{
...
static int vterm_fill_utf8(long codepoint, char *str)
{
  int nbytes = vterm_utf8_seqlen(codepoint);
