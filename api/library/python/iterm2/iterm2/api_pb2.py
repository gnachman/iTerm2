...
_RPCREGISTRATIONREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='timeout', full_name='iterm2.RPCRegistrationRequest.timeout', index=2,
  ...
  nested_types=[_RPCREGISTRATIONREQUEST_RPCARGUMENTSIGNATURE, ],
  enum_types=[
  ],
  options=None,
  is_extendable=False,
