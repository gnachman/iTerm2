...
class MainMenu:
    ...
    class Shell(enum.Enum):
        ...
        SPLIT_HORIZONTALLY_WITH_CURRENT_PROFILE = MenuItemIdentifier("Split Down", "Split Horizontally with Current Profile")
        SPLIT_VERTICALLY_WITH_CURRENT_PROFILE = MenuItemIdentifier("Split Right", "Split Vertically with Current Profile")
        SPLIT_RIGHT = MenuItemIdentifier("Split Right", "Split Vertically with Current Profile")
        SPLIT_LEFT = MenuItemIdentifier("Split Left", "Split Left")
        SPLIT_DOWN = MenuItemIdentifier("Split Down", "Split Horizontally with Current Profile")
        SPLIT_UP = MenuItemIdentifier("Split Up", "Split Up")
        SPLIT_HORIZONTALLY = MenuItemIdentifier("Split Down with Profile…", "Split Horizontally…")
        SPLIT_VERTICALLY = MenuItemIdentifier("Split Right with Profile…", "Split Vertically…")
