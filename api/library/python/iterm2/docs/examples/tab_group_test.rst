...
.. _tab_group_test_example:

Tab Groups
==========

This script creates a new window (so your other windows are left alone) and presents an interactive menu for exercising the tab group API: creating a group from a set of tabs, adding and removing tabs, renaming and recoloring a group, and collapsing or expanding it. iTerm2 keeps a group's tabs contiguous, so you can watch it reorder tabs as membership changes.

Demonstrates :attr:`iterm2.Tab.tab_group`, :attr:`iterm2.Window.tab_groups`, :meth:`iterm2.Window.async_create_tab_group`, and the mutators on :class:`iterm2.TabGroup` (:meth:`~iterm2.TabGroup.async_set_name`, :meth:`~iterm2.TabGroup.async_set_color`, and :meth:`~iterm2.TabGroup.async_set_collapsed`).
...
:Download:`Download<tab_group_test.its>`
