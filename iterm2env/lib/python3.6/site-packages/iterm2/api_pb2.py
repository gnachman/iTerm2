...
_SERVERORIGINATEDMESSAGE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='notification', full_name='iterm2.ServerOriginatedMessage.notification', index=12,
