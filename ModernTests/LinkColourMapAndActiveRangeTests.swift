...
final class ActiveLinkRangeOnLineTests: XCTestCase {
    ...
    func testNoActiveRange_returnsEmpty() {
        ...
        let result = h.activeLinkRange(onLine: 5)
    ...
    func testSingleLine_matchingRow() {
        ...
        let result = h.activeLinkRange(onLine: 10)
    ...
    func testSingleLine_nonMatchingRow() {
        ...
        XCTAssertEqual(h.activeLinkRange(onLine: 9).length, 0)
        XCTAssertEqual(h.activeLinkRange(onLine: 11).length, 0)
    }
    ...
    func testMultiLine_endRow_noWindow() {
        ...
        let result = h.activeLinkRange(onLine: 7)
        XCTAssertEqual(result.location, 0)
    ...
    func testMultiLine_interiorRow_noWindow() {
        ...
        let result = h.activeLinkRange(onLine: 6)   // interior
        XCTAssertEqual(result.location, 0)
    ...
    func testMultiLine_rowOutsideRange() {
        ...
        XCTAssertEqual(h.activeLinkRange(onLine: 4).length, 0)
        XCTAssertEqual(h.activeLinkRange(onLine: 8).length, 0)
    }
    ...
    func testMultiLine_startRow_withWindow() {
        ...
        let result = h.activeLinkRange(onLine: 3)
    ...
    func testMultiLine_interiorRow_withWindow() {
        ...
        let result = h.activeLinkRange(onLine: 4)   // interior
