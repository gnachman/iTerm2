...
//  iTerm2
//
//  Mac-only streaming parser for ExplanationResponse plus the AppKit-facing
//  AITermAnnotation bridge. Split from AIExplanationResponse.swift, which is
//  shared with the iOS companion app.
//

import Foundation

extension ExplanationResponse {
