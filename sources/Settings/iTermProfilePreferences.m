...
+ (iTermProfilePreferencesKeyFuncs)keyFuncs {
    ...
    dispatch_once(&onceToken, ^{
        ...
        NSArray *color = @[ KEY_FOREGROUND_COLOR, KEY_BACKGROUND_COLOR, KEY_BOLD_COLOR,
                            KEY_LINK_COLOR, KEY_LINK_HOVER_COLOR, KEY_LINK_ACTIVE_COLOR,
                            KEY_MATCH_COLOR, KEY_SELECTION_COLOR, KEY_SELECTED_TEXT_COLOR,
        ...
        NSArray *booleans = @[
            ...
            KEY_USE_LINK_HOVER_COLOR COLORS_LIGHT_MODE_SUFFIX,
            KEY_USE_LINK_HOVER_COLOR COLORS_DARK_MODE_SUFFIX,
            KEY_USE_LINK_HOVER_COLOR,

            KEY_USE_LINK_ACTIVE_COLOR COLORS_LIGHT_MODE_SUFFIX,
            KEY_USE_LINK_ACTIVE_COLOR COLORS_DARK_MODE_SUFFIX,
            KEY_USE_LINK_ACTIVE_COLOR,
        ...
        NSArray *number = @[
            ...
            KEY_CURSOR_TYPE, KEY_LINK_UNDERLINE_STYLE, KEY_THIN_STROKES,
...
+ (NSString *)descriptionForKey:(NSString *)key {
    ...
    if (!dict) {
        dict = @{
            ...
            KEY_LINK_HOVER_COLOR COLORS_LIGHT_MODE_SUFFIX:          @"Color for hovered links in light mode",
            KEY_USE_LINK_HOVER_COLOR COLORS_LIGHT_MODE_SUFFIX:      @"Whether to use a custom hover link colour in light mode",
            KEY_LINK_ACTIVE_COLOR COLORS_LIGHT_MODE_SUFFIX:         @"Color for active (Cmd+clicked) links in light mode",
            KEY_USE_LINK_ACTIVE_COLOR COLORS_LIGHT_MODE_SUFFIX:     @"Whether to use a custom active link colour in light mode",
            ...
            KEY_LINK_HOVER_COLOR COLORS_DARK_MODE_SUFFIX:           @"Color for hovered links in dark mode",
            KEY_USE_LINK_HOVER_COLOR COLORS_DARK_MODE_SUFFIX:       @"Whether to use a custom hover link colour in dark mode",
            KEY_LINK_ACTIVE_COLOR COLORS_DARK_MODE_SUFFIX:          @"Color for active (Cmd+clicked) links in dark mode",
            KEY_USE_LINK_ACTIVE_COLOR COLORS_DARK_MODE_SUFFIX:      @"Whether to use a custom active link colour in dark mode",
            ...
            KEY_LINK_HOVER_COLOR:                                   @"Color for hovered links",
            KEY_USE_LINK_HOVER_COLOR:                               @"Whether to use a custom hover link colour",
            KEY_LINK_ACTIVE_COLOR:                                  @"Color for active (Cmd+clicked) links",
            KEY_USE_LINK_ACTIVE_COLOR:                              @"Whether to use a custom active link colour",
            KEY_LINK_UNDERLINE_STYLE:                               @"Underline style for links: 1=Single, 2=Double, 3=Dashed, 4=Curly, 6=Dotted",
...
+ (NSDictionary *)defaultValueMap {
    ...
    if (!dict) {
        dict = @{ KEY_NAME: @"Default",
                  ...
                  KEY_LINK_HOVER_COLOR:    [[NSColor colorWithCalibratedRed:0.023 green:0.270 blue:0.678 alpha:1] dictionaryValue],
                  KEY_LINK_ACTIVE_COLOR:   [[NSColor colorWithCalibratedRed:0.023 green:0.270 blue:0.678 alpha:1] dictionaryValue],
                  ...
                  KEY_LINK_HOVER_COLOR COLORS_LIGHT_MODE_SUFFIX:    [[NSColor colorWithCalibratedRed:0.023 green:0.270 blue:0.678 alpha:1] dictionaryValue],
                  KEY_LINK_ACTIVE_COLOR COLORS_LIGHT_MODE_SUFFIX:   [[NSColor colorWithCalibratedRed:0.023 green:0.270 blue:0.678 alpha:1] dictionaryValue],
                  ...
                  KEY_LINK_HOVER_COLOR COLORS_DARK_MODE_SUFFIX:    [[NSColor colorWithCalibratedRed:0.023 green:0.270 blue:0.678 alpha:1] dictionaryValue],
                  KEY_LINK_ACTIVE_COLOR COLORS_DARK_MODE_SUFFIX:   [[NSColor colorWithCalibratedRed:0.023 green:0.270 blue:0.678 alpha:1] dictionaryValue],
                  ...
                  KEY_USE_LINK_HOVER_COLOR: @NO,
                  KEY_USE_LINK_HOVER_COLOR COLORS_LIGHT_MODE_SUFFIX: @NO,
                  KEY_USE_LINK_HOVER_COLOR COLORS_DARK_MODE_SUFFIX: @NO,

                  KEY_USE_LINK_ACTIVE_COLOR: @NO,
                  KEY_USE_LINK_ACTIVE_COLOR COLORS_LIGHT_MODE_SUFFIX: @NO,
                  KEY_USE_LINK_ACTIVE_COLOR COLORS_DARK_MODE_SUFFIX: @NO,

                  KEY_LINK_UNDERLINE_STYLE: @3,
