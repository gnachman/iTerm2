...
DEFINE_BOOL(twoRowTabBar, NO, SECTION_TABS @"Show tab bar on two rows.\nWhen enabled, tabs are distributed across two horizontal rows instead of one, giving each tab more room for its title. Only affects top/bottom tab bars; left/right bars are unchanged.");
