...
DEFINE_FLOAT(tabColorInactivityTimeoutHours, 0, SECTION_TABS @"Hide tab colors after this many hours without terminal output.\nSet to 0 to keep tab colors visible indefinitely.");
