...
DEFINE_BOOL(companionPairingAllowed, YES, SECTION_GENERAL @"Allow pairing a companion iOS device?\nThe purpose of this setting is to make it easy for managed environments to disable companion device pairing. The user defaults key is `CompanionPairingAllowed`.");
