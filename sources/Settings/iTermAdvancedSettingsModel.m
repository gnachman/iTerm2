...
DEFINE_STRING(companionResolverURL, @"https://resolver.iterm2.com/", SECTION_GENERAL @"Resolver URL for companion iOS device pairing.\nUsed to find the relay server for the phone-to-mac connection. Leave empty to use direct connections (such as if you run your own relay).");
