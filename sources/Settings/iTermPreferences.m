...
@"`get_screen_contents` FIRST. Newly-spawned programs (Claude Code's first launch, vim, less, htop, "
@"emacs, fzf, or generally any program meant for interactive use) can open at a prompt you've never "
