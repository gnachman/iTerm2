...
extension PseudoTerminal: ColorsMenuItemViewDelegate {
    ...
    private func buildSystemPickerAccessoryView(panelWidth: CGFloat) -> NSView {
        ...
        if !recentColors.isEmpty {
            ...
            let label = NSTextField(labelWithString: String(localized: "PseudoTerminal_RecentTabColors", defaultValue: "Recent Tab Colors", comment: "Label text in buildSystemPickerAccessoryView"))
        ...
        button.image = image
        button.title = String(localized: "PseudoTerminal_DefaultPicker", defaultValue: "Default Picker", comment: "Button title in buildSystemPickerAccessoryView")
