...
class iTermUploadIndicator: NSView {
    ...
    @objc init(filename: String, onCancel: @escaping () -> Void) {
        ...
        // Configure label
        label.stringValue = String(localized: "UploadIndicator.Uploading", defaultValue: "Uploading \u{201C}\(filename)\u{201D}…", comment: "Label shown while uploading a file; the value in quotes is the filename")
