...
DEFINE_SETTABLE_BOOL(rustAdblockEnabled, RustAdblockEnabled, NO, SECTION_WEB_BROWSER @"Enable advanced ad blocking in the web browser?\nThis requires the use of a MITM proxy.");
