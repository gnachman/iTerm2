...
DEFINE_BOOL(disableWindowShadowWhenTransparencyPreMojave, NO, SECTION_WINDOWS @"Disable the window shadow on High Sierra and earlier when the window has a transparent session to improve performance.");
