...
DEFINE_BOOL(workAroundNumericKeypadBug, NO, SECTION_EXPERIMENTAL @"Work around a bug in recent macOS versions where keys on the numeric keypad don't have the NumericKeypad modifier set.");
