...
DEFINE_BOOL(tabGroupNeonStyle, YES, SECTION_TABS @"Use neon gradient style for tab group labels.\nWhen enabled group labels show a gradient border with dark fill that fills on hover. When disabled they use flat solid colour fill.");
