...
DEFINE_INT(maximumBytesToProvideToPythonAPI, 100, SECTION_GENERAL @"Maximum number of bytes of selection to provide to PythonAPI.\nA large value here can cause performance issues when you have a big selection.");
...
DEFINE_BOOL(useUnixDomainSocketForAPI, NO, SECTION_SCRIPTING @"Use a unix-domain socket for the Python API instead of a TCP socket.");
