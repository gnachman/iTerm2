...
DEFINE_BOOL(lineBufferPerfCounters, NO, SECTION_DEBUGGING @"Emit LineBuffer perf counters to the system log at process exit.");
DEFINE_BOOL(appendGangPerfCounters, NO, SECTION_DEBUGGING @"Emit append-gang perf counters to the system log at process exit.");
