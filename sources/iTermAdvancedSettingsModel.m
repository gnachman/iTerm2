...
DEFINE_BOOL(disableProgressBarEscapeSequence, NO, SECTION_GENERAL @"Disable OSC 9;4 progress bar escape sequence.\nWhen enabled, iTerm2 will ignore progress bar escape sequences (OSC 9;4) sent by applications. These sequences display a progress indicator at the top of the terminal window.");
