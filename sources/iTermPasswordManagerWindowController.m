...
- (void)awakeFromNib {
    ...
    if (iTermPasswordManagerDataSourceProvider.authenticated &&
        ![iTermPasswordManagerDataSourceProvider.dataSource checkAvailability]) {
...
- (void)update {
    [self updateWithAvailability:[iTermPasswordManagerDataSourceProvider.dataSource checkAvailability]];
}
...
- (void)updateWithAvailability:(BOOL)available {
    ...
    const BOOL editable = !iTermPasswordManagerDataSourceProvider.dataSource.autogeneratedPasswordsOnly;
...
- (IBAction)add:(id)sender {
    ...
    if (iTermPasswordManagerDataSourceProvider.dataSource.autogeneratedPasswordsOnly) {
