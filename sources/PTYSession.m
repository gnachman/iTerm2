...
- (void)changeFontSizeDirection:(int)dir {
    ...
    if (dir) {
        // Grow or shrink
        DLog(@"grow/shrink");
        newFontTable = [_textview.fontTable fontTableWithGrownBy:dir];
    ...
    if (dir || self.isDivorced) {
        ...
        [self setSessionSpecificProfileValues:[@{ KEY_NORMAL_FONT: [newFontTable.asciiFont.font stringValue],
                                                 KEY_NON_ASCII_FONT: [newFontTable.defaultNonASCIIFont.font stringValue],
