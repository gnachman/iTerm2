...
+ (void)setSessionEndMessageText:(NSString *)value;
+ (NSString *)sessionRestartedMessageText;
+ (void)setSessionRestartedMessageText:(NSString *)value;
+ (NSString *)sessionFinishedMessageText;
+ (void)setSessionFinishedMessageText:(NSString *)value;
+ (NSString *)sessionEndMessageDividerStyle;
+ (void)setSessionEndMessageDividerStyle:(NSString *)value;
