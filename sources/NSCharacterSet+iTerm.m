...
+ (instancetype)fullWidthCharacterSetForUnicodeVersion:(NSInteger)version {
    ...
    dispatch_once(&onceToken, ^{
        ...
        [sFullWidth9 addCharactersInRange:NSMakeRange(0x1f6dd, 3)];
        ...
        [sFullWidth9 addCharactersInRange:NSMakeRange(0x1fa70, 5)];
        [sFullWidth9 addCharactersInRange:NSMakeRange(0x1fa78, 5)];
        [sFullWidth9 addCharactersInRange:NSMakeRange(0x1fa80, 7)];
        [sFullWidth9 addCharactersInRange:NSMakeRange(0x1fa90, 29)];
        [sFullWidth9 addCharactersInRange:NSMakeRange(0x1fab0, 11)];
        [sFullWidth9 addCharactersInRange:NSMakeRange(0x1fac0, 6)];
        [sFullWidth9 addCharactersInRange:NSMakeRange(0x1fad0, 10)];
        [sFullWidth9 addCharactersInRange:NSMakeRange(0x1fae0, 8)];
        [sFullWidth9 addCharactersInRange:NSMakeRange(0x1faf0, 7)];
...
+ (NSCharacterSet *)emojiWithDefaultEmojiPresentation {
    ...
    dispatch_once(&onceToken, ^{
        ...
        [emojiPresentation addCharactersInRange:NSMakeRange(0x1f6dd, 3)];
        ...
        [emojiPresentation addCharactersInRange:NSMakeRange(0x1fa78, 5)];
        [emojiPresentation addCharactersInRange:NSMakeRange(0x1fa80, 7)];
        [emojiPresentation addCharactersInRange:NSMakeRange(0x1fa90, 29)];
        [emojiPresentation addCharactersInRange:NSMakeRange(0x1fab0, 11)];
        [emojiPresentation addCharactersInRange:NSMakeRange(0x1fac0, 6)];
        [emojiPresentation addCharactersInRange:NSMakeRange(0x1fad0, 10)];
        [emojiPresentation addCharactersInRange:NSMakeRange(0x1fae0, 8)];
        [emojiPresentation addCharactersInRange:NSMakeRange(0x1faf0, 7)];
