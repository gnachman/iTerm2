...
class iTermClippingsView: NSView {
    ...
    private func setup() {
        ...
        if let plus = NSImage(systemSymbolName: "plus", accessibilityDescription: String(localized: "Clippings.AddClipping", defaultValue: "Add clipping", comment: "Label for the add clipping button")) {
            editSegmentedControl.setImage(plus, forSegment: 0)
        }
        if let minus = NSImage(systemSymbolName: "minus", accessibilityDescription: String(localized: "Clippings.RemoveClipping", defaultValue: "Remove clipping", comment: "Accessibility description for the remove clipping button")) {
            editSegmentedControl.setImage(minus, forSegment: 1)
        }
        if let archive = NSImage(systemSymbolName: "archivebox", accessibilityDescription: String(localized: "Clippings.ArchiveClippings", defaultValue: "Archive clippings", comment: "Accessibility description for the archive clippings button")) {
            editSegmentedControl.setImage(archive, forSegment: 2)
        }
        editSegmentedControl.setToolTip(String(localized: "Clippings.AddClipping", defaultValue: "Add clipping", comment: "Label for the add clipping button"), forSegment: 0)
        editSegmentedControl.setToolTip(String(localized: "Clippings.RemoveSelectedTooltip", defaultValue: "Remove selected clipping", comment: "Tooltip for the button that removes the selected clipping"), forSegment: 1)
        editSegmentedControl.setToolTip(String(localized: "Clippings.ArchiveAllTooltip", defaultValue: "Archive all clippings", comment: "Tooltip for the button that archives all clippings"), forSegment: 2)
        ...
        if let send = NSImage(systemSymbolName: "play.fill", accessibilityDescription: String(localized: "Clippings.SendClipping", defaultValue: "Send clipping", comment: "Accessibility description for the send clipping button")) {
            actionSegmentedControl.setImage(send, forSegment: 0)
        }
        if let copy = NSImage(systemSymbolName: "doc.on.doc", accessibilityDescription: String(localized: "Clippings.CopyClipping", defaultValue: "Copy clipping", comment: "Accessibility description for the copy clipping button")) {
            actionSegmentedControl.setImage(copy, forSegment: 1)
        }
        actionSegmentedControl.setToolTip(String(localized: "Clippings.SendSelectedTooltip", defaultValue: "Send selected to terminal", comment: "Tooltip for the button that sends the selected clipping to the terminal"), forSegment: 0)
        actionSegmentedControl.setToolTip(String(localized: "Clippings.CopySelectedTooltip", defaultValue: "Copy selected to pasteboard", comment: "Tooltip for the button that copies the selected clipping to the pasteboard"), forSegment: 1)
        ...
        if let back = NSImage(systemSymbolName: "chevron.left", accessibilityDescription: String(localized: "Clippings.PreviousArchived", defaultValue: "Previous archived clippings", comment: "Accessibility description for the previous archived clippings button")) {
            historySegmentedControl.setImage(back, forSegment: 0)
        }
        if let forward = NSImage(systemSymbolName: "chevron.right", accessibilityDescription: String(localized: "Clippings.NextArchived", defaultValue: "Next archived clippings", comment: "Accessibility description for the next archived clippings button")) {
            historySegmentedControl.setImage(forward, forSegment: 1)
        }
        historySegmentedControl.setToolTip(String(localized: "Clippings.ShowPreviousTooltip", defaultValue: "Show previous archived clippings", comment: "Tooltip for the button that shows the previous batch of archived clippings"), forSegment: 0)
        historySegmentedControl.setToolTip(String(localized: "Clippings.ShowNextTooltip", defaultValue: "Show next archived clippings", comment: "Tooltip for the button that shows the next batch of archived clippings"), forSegment: 1)
        ...
        if let xmark = NSImage(systemSymbolName: "xmark", accessibilityDescription: String(localized: "Clippings.HideClippings", defaultValue: "Hide clippings", comment: "Tooltip for the button that hides the clippings panel")) {
        ...
        closeButton.toolTip = String(localized: "Clippings.HideClippings", defaultValue: "Hide clippings", comment: "Tooltip for the button that hides the clippings panel")
    ...
    private func updateSelectionDependentSegments() {
        ...
        if !viewingLive {
            ...
            historyStatusLabel.toolTip = String(localized: "Clippings.ViewingArchivedTooltip", defaultValue: "Viewing archived clippings (\(historyIndex + 1) of \(total))", comment: "Tooltip while viewing archived clippings; first number is the current position, second is the total count")
...
private class ClippingsCellView: NSTableCellView {
    ...
    private func setupSubviews() {
        ...
        if let glass = NSImage(systemSymbolName: "magnifyingglass",
                               accessibilityDescription: String(localized: "Clippings.PreviewClippingAccessibility", defaultValue: "Preview clipping", comment: "Accessibility description for the preview clipping button")) {
        ...
        previewButton.toolTip = String(localized: "Clippings.PreviewTooltip", defaultValue: "Preview (Space)", comment: "Tooltip for the preview button; Space is the keyboard shortcut")
