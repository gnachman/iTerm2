...
- (void)generateHotkeyWindowProfile {
    ...
    [dict setObject:[NSNumber numberWithFloat:0.3] forKey:KEY_BACKGROUND_TRANS];
    [dict setObject:[NSNumber numberWithFloat:2.0] forKey:KEY_BACKGROUND_BLUR_RADIUS];
    [dict setObject:[NSNumber numberWithBool:YES] forKey:KEY_BLUR];
    [dict setObject:[NSNumber numberWithBool:YES] forKey:KEY_BACKGROUND_BLUR];
    [dict setObject:[NSNumber numberWithBool:YES] forKey:KEY_USE_BACKGROUND_TRANS];
