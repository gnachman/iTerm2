...
extension PTYSession {
    ...
    func becomeBrowser(configuration: WKWebViewConfiguration,
        ...
        let terminalOnlyKeys = [
            ...
            KEY_LINK_HOVER_COLOR: nullValue,
            KEY_LINK_HOVER_COLOR + COLORS_LIGHT_MODE_SUFFIX: nullValue,
            KEY_LINK_HOVER_COLOR + COLORS_DARK_MODE_SUFFIX: nullValue,
            KEY_USE_LINK_HOVER_COLOR: nullValue,
            KEY_USE_LINK_HOVER_COLOR + COLORS_LIGHT_MODE_SUFFIX: nullValue,
            KEY_USE_LINK_HOVER_COLOR + COLORS_DARK_MODE_SUFFIX: nullValue,
            KEY_LINK_ACTIVE_COLOR: nullValue,
            KEY_LINK_ACTIVE_COLOR + COLORS_LIGHT_MODE_SUFFIX: nullValue,
            KEY_LINK_ACTIVE_COLOR + COLORS_DARK_MODE_SUFFIX: nullValue,
            KEY_USE_LINK_ACTIVE_COLOR: nullValue,
            KEY_USE_LINK_ACTIVE_COLOR + COLORS_LIGHT_MODE_SUFFIX: nullValue,
            KEY_USE_LINK_ACTIVE_COLOR + COLORS_DARK_MODE_SUFFIX: nullValue,
            KEY_LINK_UNDERLINE_STYLE: nullValue,
