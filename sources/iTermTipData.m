...
+ (NSDictionary *)allTips {
  return @{ @"0001": @{ kTipTitleKey: @"Timestamps",
            ...
            @"0015": @{ kTipTitleKey: @"Tab Menu",
                        kTipBodyKey: @"Right click on a tab to change its color or to close tabs to the right or even all other tabs." },
            ...
            @"0045": @{ kTipTitleKey: @"Triggers",
                        kTipBodyKey: @"iTerm2 can automatically perform actions you define when text matching a regular expression is received. Set it up in “Prefs > Profiles > Advanced > Triggers.”",
