...
@property(nonatomic, assign) __unsafe_unretained id<WindowControllerInterface> parentWindow;  // Parent controller. Always set. Equals one of realParent or fakeParent.
