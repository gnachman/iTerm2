...
- (NSArray<iTermStatusBarComponentKnob *> *)statusBarComponentKnobs {
    iTermStatusBarComponentKnob *textColorKnob =
        [[iTermStatusBarComponentKnob alloc] initWithLabelText:ITLocalize(@"StatusBarTextComponent_StatusBarKnob_TextColor", @"Text Color:", @"Status bar knob")
                                                          type:iTermStatusBarComponentKnobTypeColor
                                                   placeholder:nil
                                                  defaultValue:nil
                                                           key:iTermStatusBarSharedTextColorKey];
    iTermStatusBarComponentKnob *backgroundColorKnob =
        [[iTermStatusBarComponentKnob alloc] initWithLabelText:ITLocalize(@"StatusBarTextComponent_StatusBarKnob_BackgroundColor", @"Background Color:", @"Status bar knob")
                                                          type:iTermStatusBarComponentKnobTypeColor
                                                   placeholder:nil
                                                  defaultValue:nil
                                                           key:iTermStatusBarSharedBackgroundColorKey];
    iTermStatusBarComponentKnob *fontKnob =
        [[iTermStatusBarComponentKnob alloc] initWithLabelText:ITLocalize(@"StatusBarTextComponent_StatusBarKnob_CustomFont", @"Custom Font", @"Status bar knob")
