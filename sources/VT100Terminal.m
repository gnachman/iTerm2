...
- (void)executeFileCommandWithValue:(NSString *)value {
    ...
    //   type=<string>                     Default: auto-detect; otherwise gives a mime type.
    //   language=<string>                 Default: auto-detect; otherwise gives a language name (implies textual content).
