...
//        if (defaultBackground && _backgroundImage) {
        // I think this part is unnecessary because the blending happens in the bg color vertex shader.
//            alpha = iTermAlphaValueForTopView(1 - _configuration->_transparencyAlpha,
//                                              _configuration->_backgroundImageBlend);

            // I believe this clause is unnecessary. enableBlending is always NO. Default background w/ non-reverse video should be
            // transparent because whatever color you choose will always be blended with the default background since the legacy
            // renderer has a view with the default background color under the textview.
