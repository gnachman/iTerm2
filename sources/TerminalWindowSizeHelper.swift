...
extension iTermWindowType {
    var percentageEligible: Bool {
        ...
        case .WINDOW_TYPE_TOP_PERCENTAGE, .WINDOW_TYPE_BOTTOM_PERCENTAGE,
            ...
            true
        case .WINDOW_TYPE_NORMAL, .WINDOW_TYPE_TRADITIONAL_FULL_SCREEN,
                .WINDOW_TYPE_LION_FULL_SCREEN, .WINDOW_TYPE_BOTTOM_CELLS, .WINDOW_TYPE_TOP_CELLS,
                .WINDOW_TYPE_LEFT_CELLS, .WINDOW_TYPE_RIGHT_CELLS, .WINDOW_TYPE_NO_TITLE_BAR,
                .WINDOW_TYPE_COMPACT, .WINDOW_TYPE_ACCESSORY, .WINDOW_TYPE_MAXIMIZED,
                .WINDOW_TYPE_COMPACT_MAXIMIZED, .WINDOW_TYPE_CENTERED:
            false
        @unknown default:
            it_fatalError()
        }
