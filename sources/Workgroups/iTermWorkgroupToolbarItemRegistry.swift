...
enum iTermWorkgroupToolbarItemRegistry {
    ...
    static let all: [iTermWorkgroupToolbarItemMetadata] = [
        ...
        .init(kind: .usage,
              displayName: String(localized: "WorkgroupToolbarItemRegistry.Usage", defaultValue: "AI Usage", comment: "Toolbar item name: AI usage gauge"),
              hasParameters: true,
              defaultValue: .usage(provider: .anthropicClaudeCode, command: "", intervalSeconds: 60)),
        .init(kind: .spacer,
