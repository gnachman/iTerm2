...
typedef struct {
    iTermPreciseTimerStats *attrsForChar;  //  &_stats[TIMER_ATTRS_FOR_CHAR]);
    iTermPreciseTimerStats *shouldSegment;  //  &_stats[TIMER_SHOULD_SEGMENT]);
    iTermPreciseTimerStats *buildMutableAttributedString;  // &_stats[TIMER_STAT_BUILD_MUTABLE_ATTRIBUTED_STRING]
    iTermPreciseTimerStats *combineAttributes;  // &_stats[TIMER_COMBINE_ATTRIBUTES]
    iTermPreciseTimerStats *updateBuilder;  // &_stats[TIMER_UPDATE_BUILDER]
    iTermPreciseTimerStats *advances;  // &_stats[TIMER_ADVANCES]
...
@property (nonatomic, readonly) iTermAttributedStringBuilderStats stats;
...
asciiLigaturesAvailable:(BOOL)asciiLigaturesAvailable
     asciiLigatures:(BOOL)asciiLigatures
              stats:(iTermAttributedStringBuilderStats)stats
